		...
		<tr>
			...
			<td>
				...
				if(bbs.getDel() == 0){
					%>
					<%=arrow(bbs.getDepth()) %>
					<a href="mymyQueryBbsDetail.jsp?seq=<%=bbs.getSeq() %>">
						<%=bbs.getTitle() %>
					</a>
					<%
				}else{
...
<div align="center">
<!-- /////////////////////////////////////////////////////////////////////////////// -->
<a href="mymyQueryBbsWrite.jsp">글쓰기</a>
</div>
<div align="center">
...
function searchBtn() {
	...
	location.href = "mymyQueryBbs.jsp?choice=" + choice + "&search=" + search;
}
...
function goPage( pageNum ) {
	...
	location.href="mymyQueryBbs.jsp?choice=" + choice + "&search=" + search + "&pageNumber=" + pageNum;
}
