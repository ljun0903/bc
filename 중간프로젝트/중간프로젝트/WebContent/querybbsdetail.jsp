...
<%
if(dto.getId().equals(mem.getId())	|| mem.getId().equals("aaa")){
%>
<tr>
	<th>작성자</th>
	<td>
...
<button type="button" onclick="location.href='querybbslist.jsp'">글목록</button>

<button type="button" onclick="updateBbs(<%=dto.getSeq() %>)">수정</button>
<button type="button" onclick="deleteBbs(<%=dto.getSeq() %>)">삭제</button>
<button type="button" onclick="report(<%=dto.getSeq() %>)">신고</button>
...
function answerBbs( seq ) {
	location.href = "queryanswer.jsp?seq=" + seq;
}
function updateBbs( seq ) {
	location.href = "querybbsupdate.jsp?seq=" + seq;
}
function deleteBbs( seq ) {
	location.href = "querybbsdelete.jsp?seq=" + seq;
}
/* function report( seq ) {
