...
<br>
<button type="button" onclick="location.href='mymyQueryBbs.jsp'">글목록</button>
...
function updateBbs( seq ) {
	location.href = "mymyQueryBbsUpdate.jsp?seq=" + seq;
}
function deleteBbs( seq ) {
	location.href = "mymyQueryBbsDelete.jsp?seq=" + seq;
}
/* function report( seq ) {
