		...
		<tr>
			...
			<td>
				...
				if(bbs.getDel() == 0){
					%>
					<%=arrow(bbs.getDepth()) %>
					<a href="querybbsdetail.jsp?seq=<%=bbs.getSeq() %>">
						<%=bbs.getTitle() %>
					</a>
					<%
				}else{
...
<br>
<div align="center">
<a href="querybbswrite.jsp">글쓰기</a>
</div>
<div align="center">
...
function searchBtn() {
	...
	location.href = "querybbslist.jsp?choice=" + choice + "&search=" + search;
}
...
function goPage( pageNum ) {
	...
	location.href="querybbslist.jsp?choice=" + choice + "&search=" + search + "&pageNumber=" + pageNum;
}
