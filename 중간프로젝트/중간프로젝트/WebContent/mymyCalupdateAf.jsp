...
<title>mymycalupdateAf.jsp</title>
</head>
<body>
...
boolean isS = dao.updateCal(new CalendarDto(seq, "",name, title, content, rdate, "", labelcol));

String urllist = String.format("%s?year=%s&month=%s", "mymyCalendar.jsp", year, month);
