...
RECCONTENT LONG NOT NULL,   --요리순서 글
...
SEQ_CLASS NUMBER(10), --어떤 클래스의 댓글인가
...
ADD CONSTRAINT FK_COMMENT_CLASS_SEQ_CLASS FOREIGN KEY (SEQ_CLASS)
REFERENCES COOKCLASS(SEQ);
...
SEQ NUMBER(10) PRIMARY KEY, --시퀀스
NICKNAME VARCHAR2(50) NOT NULL, --닉네임
SEQ_CLASS NUMBER(10) NOT NULL, --참가한 시퀀스
TITLE VARCHAR2(2000) NOT NULL, --글의 제목
RDATE DATE NOT NULL,   --참가한 날짜
CDATE VARCHAR2(12) NOT NULL, -- 수업날짜
AUTH NUMBER(1) NOT NULL --강사 0, 학생1 
);
...
SUBCA VARCHAR(20) NOT NULL, -- 상품 서브 카테고리(검색용)
...
ID VARCHAR2(50) NOT NULL, -- 주문자 아이디
ORDERNUM VARCHAR2(100) NOT NULL,  --주문번호
ITEMNUM NUMBER(8) NOT NULL, --상품 번호
TITLE VARCHAR2(50) NOT NULL,    --상품명
MAINPT VARCHAR2(50) NOT NULL,  --상품 썸네일 사진
PRICE NUMBER(20) NOT NULL,     --상품 가격
...
DROP SEQUENCE SEQ_ITEMREVIEW;

CREATE TABLE ITEMREVIEW(
SEQ NUMBER(10) PRIMARY KEY, -- 시퀀스
NICKNAME VARCHAR2(50) NOT NULL, --작성자
ORDERNUM VARCHAR2(100) NOT NULL,  --주문번호(리뷰 작성하면 버튼 바꾸기위해)
ITEMNUM NUMBER(10), --어떤 상품 리뷰인가
TITLE VARCHAR2(1000) NOT NULL, -- 리뷰 제목
CONTENT VARCHAR2(1000) NOT NULL, --리뷰내용
RDATE DATE NOT NULL --작성날짜
);

CREATE SEQUENCE SEQ_ITEMREVIEW
START WITH 1
INCREMENT BY 1;
