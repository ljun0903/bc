...
System.out.println("myReviewBbs.jsp pdsnum: "+pdsnum);
...
function searchBtn() {
	...
	location.href = "myReviewBbs.jsp?pdsnum=<%=pdsnum%>&choice=" + choice + "&search=" + search;
}
...
function goPage( pageNum ) {
	...
	location.href = "myReviewBbs.jsp?pdsnum=<%=pdsnum%>&choice=" + search + "&pageNumber=" + pageNum;
}
