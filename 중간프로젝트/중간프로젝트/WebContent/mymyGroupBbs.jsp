...
List<PdsDto> list = dao.getMyPdsPagingList(name, pdsnum, choice, search, pageNumber);

// 글의 총 수
int len = dao.getMyAllPds(name, pdsnum, choice, search);
...
<header class="py-5">
	<div class="container px-lg-5">
		<table>
			<col width="30"><col width="500"><col width="30"><col width="80">
			<tr>
...
//	alert('searchBtn');	
	...
	location.href = "mymyGroupBbs.jsp?pdsnum=<%=pdsnum%>&name=<%=mem.getName()%>&choice=" + choice + "&search=" + search;	// 자기자신으로(리스트)
}
...
function goPage( pageNum ) {
	...
	location.href = "mymyGroupBbs.jsp?pdsnum=<%=pdsnum%>&name=<%=mem.getName()%>&choice=" + choice + "&search=" + search + "&pageNumber=" + pageNum;
}
